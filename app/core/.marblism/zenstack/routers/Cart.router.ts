...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.CartInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).cart.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.CartInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).cart.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.CartInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).cart.findFirst(input as any))),

        findMany: procedure.input($Schema.CartInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).cart.findMany(input as any))),
        ...
        count: procedure.input($Schema.CartInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).cart.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.CartCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.CartCountAggregateOutputType>
            : number>(
