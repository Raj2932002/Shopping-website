...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.CartItemInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).cartItem.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.CartItemInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).cartItem.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.CartItemInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).cartItem.findFirst(input as any))),

        findMany: procedure.input($Schema.CartItemInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).cartItem.findMany(input as any))),
        ...
        count: procedure.input($Schema.CartItemInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).cartItem.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.CartItemCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.CartItemCountAggregateOutputType>
            : number>(
